...
# 1投クリア: 短い明るいブリップ
save("throw_clear.wav", mix(
    (tone(E6, 0.18, (1, 0.4, 0.2), decay=0.7), 0.00, 1.0),
    (noise(0.08, 0.03), 0.00, 0.2),
))

# 1投ミス: 短い低いサッ
save("throw_miss.wav", mix(
    (square(196.00, 0.14, decay=0.6), 0.00, 0.8),
    (noise(0.14, 0.05), 0.00, 0.5),
))

# ラストチャンス: 緊張感のある低い一撃
save("lastchance.wav", mix(
    (tone(110.0, 0.7, (1, 0.6, 0.3), decay=0.85), 0.00, 1.0),
    (tone(220.0, 0.7, (1, 0.4), vib=0.01, decay=0.85), 0.02, 0.5),
    (noise(0.5, 0.15), 0.00, 0.25),
))
